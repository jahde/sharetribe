...
module TestHelpers
  ...
  def load_default_test_data_to_db_before_suite
    community1 = FactoryGirl.create(:community, :username => "test", :consent => "test_consent0.1", :settings => {"locales" => ["en", "fi"]}, :real_name_required => true)
    community1.community_customizations.create(name: "Sharetribe", locale: "fi")
    community2 = FactoryGirl.create(:community, :username => "test2", :consent => "KASSI_FI1.0", :settings => {"locales" => ["en"]}, :real_name_required => true, :allowed_emails => "@example.com")
    community3 = FactoryGirl.create(:community, :username => "test3", :consent => "KASSI_FI1.0", :settings => {"locales" => ["en"]}, :real_name_required => true)
  ...
  def load_default_test_data_to_db_before_test
    community1 = Community.where(username: "test").first
    community2 = Community.where(username: "test2").first
    community3 = Community.where(username: "test3").first
